    ...
    <Container>
      <section className="mx-auto w-full max-w-7xl px-0 sm:px-2 lg:px-4">
        <Card className="overflow-hidden border-border/70 bg-card/90 shadow-soft">
          <CardHeader className="border-b border-border/60 bg-muted/30 px-6 py-6 sm:px-8">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-separate border-spacing-0">
                <thead className="sticky top-0 z-10 bg-card/95 backdrop-blur">
                  <tr>
                    <th className="border-b border-border/60 px-6 py-4 text-left text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground sm:px-8">
                      Campo
                    </th>
                    <th className="border-b border-border/60 px-6 py-4 text-left text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground sm:px-8">
                      Valor
                ...
                <tbody>
                  {rows.map(([key, value], index) => (
                    ...
                    >
                      <td className="w-[280px] border-b border-border/60 px-6 py-5 align-top text-sm font-semibold text-primary sm:px-8">
                        {formatLabel(key)}
                      </td>
                      <td className="border-b border-border/60 px-6 py-5 align-top text-sm text-foreground sm:px-8">
                        <pre className="max-w-full whitespace-pre-wrap break-words font-mono text-[0.92rem] leading-6 text-foreground/90">
                          {formatValue(value)}
                        </pre>
                      </td>
                    </tr>
