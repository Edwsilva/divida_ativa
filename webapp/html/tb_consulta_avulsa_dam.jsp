...
<liferay-portlet:renderURL var="consultarDamURL">
	<portlet:param name="action" value="consultarDam" />
	<portlet:param name="origem" value="${origem}" />
	<portlet:param name="numInscricao" value="${numInscricao}" />	
...
<div id="consultaAvulsaDam">

	<form action="${consultarDamURL}" method="post">	
